...
namespace IndoorPositionApp.Pages.Modems
{
    ...
    public partial class Calib6 : ContentPage
    {
        int bandera = 0;
        ...
        private async void InitPicker()
        {
            ...
            try
            {
                ...
                string rssiP = Connection.Instance.ReturnRSSI(6);

                labelRSSI1.Text = rssiP;

                string valorK = Connection.Instance.ReturnK(6);
                labelK1.Text = valorK;

                string modem = Connection.Instance.ReturnMod(6);
