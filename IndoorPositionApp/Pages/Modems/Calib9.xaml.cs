...
namespace IndoorPositionApp.Pages.Modems
{
    ...
    public partial class Calib9 : ContentPage
    {
        int bandera = 0;
        ...
        private async void InitPicker()
        {
            ...
            try
            {
                ...
                string rssiP = Connection.Instance.ReturnRSSI(9);

                labelRSSI1.Text = rssiP;

                string valorK = Connection.Instance.ReturnK(9);
                labelK1.Text = valorK;

                string modem = Connection.Instance.ReturnMod(9);
